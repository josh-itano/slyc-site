...
function Nav({ page, setPage, cart, setCartOpen }) {
  ...
  const onHero = !scrolled && page === "home";
  const iconColor = onHero ? C.white : C.navy;

  const navStyle = {
    position: "fixed", top: 0, width: "100%", zIndex: 1000,
    padding: isMobile ? (scrolled ? "14px 16px" : "16px 16px") : (scrolled ? "14px 40px" : "20px 40px"),
    ...
    <>
      <nav style={navStyle}>
        <a onClick={() => { setPage("home"); window.scrollTo({ top: 0, behavior: "smooth" }); }} style={{ cursor: "pointer" }}>
          <span style={{ fontSize: scrolled ? 22 : 28, fontWeight: 900, color: onHero ? C.white : C.navy, letterSpacing: 6, transition: "font-size 0.4s", display: "inline-block" }}>SLYC</span>
        </a>
        ...
        <div style={{ display: "flex", gap: 16, alignItems: "center" }} className="nav-mobile">
          ...
          <Menu size={24} color={iconColor} style={{ cursor: "pointer" }} onClick={() => setMobileOpen(true)} />
        </div>
      </nav>
...
function CartDrawer({ cart, setCart, open, setOpen, setPage }) {
  ...
  return (
    <>
      ...
      <div style={{ position: "fixed", top: 0, right: 0, bottom: 0, width: isMobile ? "100%" : 440, background: C.white, zIndex: 3001, transform: open ? "translateX(0)" : "translateX(100%)", transition: "transform 0.4s cubic-bezier(0.4,0,0.2,1)", display: "flex", flexDirection: "column" }}>
...
function About() {
  const isMobile = useIsMobile();
  return (
    <section id="about" style={{ padding: isMobile ? "60px 20px" : "140px 40px", maxWidth: 1400, margin: "0 auto", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? 48 : 100, alignItems: "center" }}>
      <Reveal>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 32, marginTop: 48, paddingTop: 48, borderTop: `1px solid rgba(17,34,77,0.1)` }}>
          {[["2", "Trips / Year"], ["50+", "Events Hosted"], ["CO", "Home Base"]].map(([n, l]) => (
            <div key={l}>
              <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: isMobile ? 36 : 48, color: C.navy, lineHeight: 1 }}>{n}</div>
...
function TripsSection() {
  ...
  const isMobile = useIsMobile();
  return (
    <section id="trips" style={{ background: C.navy, padding: isMobile ? "60px 20px" : "120px 40px", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(3,1fr)", gap: 24 }}>
        {trips.map((t, i) => (
...
function EventsSection() {
  ...
  const isMobile = useIsMobile();
  return (
    <section id="events" style={{ padding: isMobile ? "60px 20px" : "140px 40px", maxWidth: 1200, margin: "0 auto" }}>
      <Reveal>
        <div style={{ textAlign: "center", marginBottom: 80 }}>
      ...
      <div>
        {events.map((e, i) => (
          <Reveal key={i} delay={i * 0.08}>
            <div
              style={{ display: "grid", gridTemplateColumns: isMobile ? "72px 1fr" : "120px 1fr auto", gap: isMobile ? 16 : 40, alignItems: "center", padding: isMobile ? "28px 0" : "40px 0", borderBottom: `1px solid rgba(17,34,77,0.1)`, borderTop: i === 0 ? `1px solid rgba(17,34,77,0.1)` : "none", cursor: "pointer", transition: "padding-left 0.3s" }}
              onMouseEnter={el => el.currentTarget.style.paddingLeft = "20px"}
              onMouseLeave={el => el.currentTarget.style.paddingLeft = "0px"}
            >
              <div style={{ textAlign: "center" }}>
                <div style={{ fontSize: 10, letterSpacing: 2, textTransform: "uppercase", color: C.orange, fontWeight: 600 }}>{e.month}</div>
                <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: isMobile ? 40 : 52, color: C.navy, lineHeight: 1 }}>{e.day}</div>
              </div>
              <div>
              ...
              {!isMobile && <div style={{ fontSize: 12, letterSpacing: 2, textTransform: "uppercase", color: C.textMuted, whiteSpace: "nowrap" }}>{e.location}</div>}
            </div>
          </Reveal>
        ))}
      </div>
...
function FeaturedProducts({ setPage, setSelectedProduct }) {
  ...
  const isMobile = useIsMobile();
  return (
    <section style={{ background: C.cream, padding: isMobile ? "60px 20px" : "140px 40px" }}>
      <Reveal>
...
function LifestyleQuote() {
  const isMobile = useIsMobile();
  return (
    <section style={{ height: "70vh", minHeight: isMobile ? 280 : 500, background: C.navy, display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden" }}>
...
function MembersSection({ setPage }) {
  ...
  return (
    <section id="members" style={{ padding: isMobile ? "60px 20px" : "140px 40px", maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
      <Reveal>
...
function Footer({ setPage }) {
  ...
  return (
    <footer style={{ background: C.black, padding: isMobile ? "60px 20px 32px" : "80px 40px 40px" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1.5fr 1fr 1fr 1fr", gap: isMobile ? 40 : 60 }}>
        <div>
...
function ShopPage({ setPage, setSelectedProduct }) {
  ...
  return (
    <div style={{ paddingTop: 100 }}>
      ...
      {/* Filters */}
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: isMobile ? "24px 20px 0" : "40px 40px 0" }}>
      ...
      {/* Product Grid */}
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: isMobile ? "0 20px 80px" : "0 40px 120px", display: "grid", gridTemplateColumns: isSmallPhone ? "1fr" : isMobile ? "repeat(2,1fr)" : "repeat(auto-fill, minmax(260px, 1fr))", gap: isMobile ? 12 : 24 }}>
        {filtered.map((p, i) => (
...
function ProductPage({ productId, setPage, cart, setCart, setSelectedProduct }) {
  ...
  return (
    <div style={{ paddingTop: 100 }}>
      {/* Breadcrumb */}
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: isMobile ? "20px 20px" : "20px 40px" }}>
      ...
      {/* Product layout */}
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: isMobile ? "20px 20px 60px" : "40px 40px 80px", display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? 32 : 80, alignItems: "start" }}>
      ...
      {/* Related products */}
      {related.length > 0 && (
        <div style={{ background: C.cream, padding: isMobile ? "60px 20px" : "80px 40px" }}>
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "repeat(2,1fr)" : `repeat(${Math.min(related.length, 4)}, 1fr)`, gap: isMobile ? 12 : 24 }}>
              {related.map(p => (
                <div key={p.id}
...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: C.white, color: C.navy, minHeight: "100vh", overflowX: "hidden" }}>
      <style>{`
